...
Lighting of 3D polygon layers is controlled by providing a `light()` specification to the layer function or to `coord_3d()`. See the [lighting and shading](https://matthewkling.github.io/ggcube/articles/lighting.html) article for a comprehensive guide.
