...
Lighting of surface and prism layers is controlled by providing a `lighting()` specification. Light can be mapped to an aesthetic variable using `after_stat(light)`, or can be used to `shade` otherwise-defined color and fill aesthetics by adding highlights and shadows:
