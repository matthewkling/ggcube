...
ggcube isn't yet available on CRAN as it's still in initial development. You can install the development version of ggcube from [GitHub](https://github.com/matthewkling/ggcube) with:
