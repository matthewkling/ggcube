...
See the [surfaces](https://matthewkling.github.io/ggcube/articles/surfaces.html) article for a full guide to the surface system.
...
Example: a terrain surface using `geom_contour_3d()`, also showing functionality for animation as a rotating GIF:

```{r contour_anim, warning = FALSE, message = FALSE}
